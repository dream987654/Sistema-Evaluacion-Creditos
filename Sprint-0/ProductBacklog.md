...
| ----- | -------------------------------------------------------------------------------------------------------- | --------- | -------- |
| HU-01 | Como asesor financiero, quiero registrar una solicitud de crédito para iniciar el proceso de evaluación. | Alta      | Sprint 2 |
| HU-02 | Como evaluador, quiero revisar la información del solicitante para emitir una decisión.                  | Alta      | Sprint 3 |
| HU-03 | Como supervisor, quiero aprobar o rechazar una solicitud para continuar con el proceso.                  | Alta      | Sprint 4 |
